        ...
        <div class="glass-card p-8 flex flex-wrap gap-8 items-center border-b-4 border-blue-500/20 rounded-[2.5rem]">
            <form class="flex flex-wrap gap-8 items-end w-full" id="filterForm">
                <div class="space-y-3">
                    ...
                    <input type="date" name="start_date" value="<?php echo $start_date; ?>" class="px-8 py-4 rounded-2xl text-[12px] font-black uppercase tracking-widest border border-slate-200 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all">
                </div>
                <div class="space-y-3">
