    ...
    <nav class="glass-nav sticky top-0 z-30">
        <div class="px-4 md:px-6 py-4 flex justify-between items-center mx-auto">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl font-black text-slate-900 tracking-tight uppercase">Spare Parts Inventory</h1>
            </div>
            <div class="flex items-center gap-3">
                <a href="manage_handler.php?action=export_inventory&type=spare_part" class="bg-white text-emerald-600 px-6 py-2.5 rounded-xl text-xs font-black hover:bg-emerald-50 transition-all uppercase tracking-widest border-2 border-emerald-100 flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    Export Excel
                </a>
                <button onclick="openNewProductModal()" class="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-6 py-2.5 rounded-xl text-xs font-black hover:shadow-lg hover:shadow-blue-500/30 transition-all uppercase tracking-widest border-2 border-white">+ Add Spare Part</button>
            </div>
        </div>
    </nav>
            ...
            <div class="overflow-x-auto">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="px-8 py-5 text-[10px] uppercase tracking-[0.2em] text-right text-indigo-400">Estimated Price</th>
            ...
            data.products.forEach(p => {
                ...
                const row = `
                    <tr class="${rowClass} transition-all group cursor-pointer" onclick="openQuickBatchModal(${JSON.stringify(p).replace(/"/g, '&quot;')})">
                        ...
                        <td class="px-8 py-5 text-right font-mono font-black text-indigo-700">
                             ${parseFloat(p.estimated_selling_price || 0).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                        </td>
                        <td class="px-8 py-5 text-right font-mono font-black text-purple-800">
                            ${qtyDisplay}
                        </td>
                        <td class="px-8 py-5 text-right font-mono font-black text-emerald-800">
